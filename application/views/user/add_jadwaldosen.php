      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
           ...
           Add New Teaching Schedule</div>

          <div class="card-body">
            <div class="table-responsive">
              
              <form action="<?= base_url('user/addjadwaldosen/'); ?>" method="post">
                ...
                <button type="submit" class="btn btn-primary mt-3 float-right">Add New Teaching Schedule</button>
              </form>
